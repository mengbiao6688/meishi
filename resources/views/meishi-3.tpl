                     	 ...
                     	 <div class="bg">
                             <div class="padding">
                                  <h3 class="p2">Good Cook</h3>
                                     <div class="wrapper p3">
                                             ...
                                             <div class="extra-wrap">
                                                 <h6 style="height:35px;">蒜苗回锅肉<{$_meishi.name}></h6>
                                                 <div class="cailiao">
                                                    <h8>主料</h8>
                                                    <ul class="cllb">
                                                        <li><a><h9>猪肉</h9><span>300克</span></a></li>
                                                        <li><a><h9>蒜苗</h9><span>1把</span></a></li>
                                  ...
                                  <h3 class="p2" style="border-bottom:#eeeeee 1px solid; margin-top:-8px; line-height:2.2em;" >做法</h3>
                             		  <div class="wrapper p3">
                               			 <figure class="img-indent"><img  src="<{'static/img/meishi/page3/smhgr/smhgr1.png'|url}>" alt=""/></figure>
                                 		 <div class="extra-wrap"> 
                                            <h10>1、</h10>
                                     ...
                                     <div class="wrapper p3">
                                    	<figure class="img-indent"><img  src="<{'static/img/meishi/page3/smhgr/smhgr2.png'|url}>" alt=""/></figure>
                                        <div class="extra-wrap">
                                            <h10>2、</h10>
                                     ...
                                     <div class="wrapper p3">
                                    	<figure class="img-indent"><img  src="<{'static/img/meishi/page3/smhgr/smhgr3.png'|url}>" alt=""/></figure>
                                        <div class="extra-wrap">
                                            <h10>3、</h10>
